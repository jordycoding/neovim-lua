...
function M.on_attach(client, bufnr)
	...
	vim.api.nvim_buf_set_keymap(
		...
		"n",
		"<localleader>wl",
		"<cmd>lua print(vim.inspect(vim.lsp.buf.list_worklocalleader_folders()))<CR>",
		opts
	)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<localleader>e", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
